...
export default function CandidaturasLaPazPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#de2488]/5 via-white to-[#00cfaf]/5">
      ...
      <main className="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-8 py-12 sm:py-16">
        ...
        <header className="mt-6 text-center">
          ...
          <h1 className="mt-4 text-3xl sm:text-4xl font-black text-slate-900">Departamento de La Paz</h1>
          <p className="mt-3 text-slate-600 max-w-2xl mx-auto">
            Revisa las candidaturas para gobernacion, alcaldia de La Paz y alcaldia de El Alto.
          </p>
        </header>
