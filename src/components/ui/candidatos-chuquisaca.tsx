...
const candidatosGobernacion: Candidato[] = [
	{
		nombre: "Luis Edson Ayllón",
		partido: "Alianza Gente Nueva",
		imagen: "/candidaturas_c/segunda_vuelta/Luis Edson Ayllón.webp"
	},
	{
		nombre: "Gróver Franz García",
		partido: "Alianza Patria Unidos",
		imagen: "/candidaturas_c/segunda_vuelta/Gróver Franz García.webp"
	}
]

export default function CandidatosChuquisaca() {
	return (
		<section id="candidatos-chuquisaca" className="w-full max-w-6xl mx-auto px-4 py-12">
			<header className="text-center mb-10">
				<div className="mx-auto mb-4 h-1 w-32 rounded-full bg-[#87c7ff]"></div>
				<h2 className="text-3xl font-bold text-black">Candidatos Chuquisaca</h2>
				<p className="mt-2 text-gray-600">Segunda vuelta para gobernación: nombre y organización política.</p>
			</header>

			<div>
				<h3 className="text-2xl font-semibold text-black mb-6 text-center">
					Candidatos a la gobernación de Chuquisaca
				</h3>
