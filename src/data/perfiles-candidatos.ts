...
export const perfilesCandidatos: BinomioCandidatos[] = [
  ...
  },
  {
    ...
    vicepresidente: {
      ...
      edad: 39,
      educacion: [
        "Formación jurídica en Derecho",
        "Academia policial (2007)",
  ...
  },
  {
    ...
    presidente: {
      ...
      educacion: [
        ...
        "Formación empresarial en el sector cervecero",
  ...
  {
    partido: {
      nombre: "Alianza Libertad y Progreso ADN",
      sigla: "ADN",
      slug: "adn"
    },
    presidente: {
    ...
    vicepresidente: {
      ...
      educacion: [
        ...
        "Maestría en Economía - Universidad Estatal de Arizona",
      ...
      carreraPolitica: [
        ...
        "Candidato a vicepresidente por Alianza Libertad y Progreso ADN"
      ],
      partidosAnteriores: [
        "Partido Liberal Boliviano"
      ],
      logrosDestacados: [
        ...
        "Trabajo centrado en docencia, investigación y consultoría",
        "Expertise en fundamentos del capitalismo y la libertad económica"
      ]
    },
    estado: "inhabilitado",
