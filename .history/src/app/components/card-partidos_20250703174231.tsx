          ...
          >
            ...
            <CardContent className="p-6 relative z-10 flex flex-col items-center text-center h-full">
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <Button
                  size="sm"
                  className={`w-full font-bold rounded-xl transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-lg text-xs group/btn ${
                    partido.colores?.primary === "#ffdf00" ? "text-black" : "text-white"
                  }`}
                  style={{
                    backgroundColor: partido.colores?.primary || "#6c757d",
                  ...
                  onMouseEnter={(e) => {
                    ...
                    if (partido.colores?.primary) {
                      // Para UN (amarillo), usar un color más oscuro en hover
                      if (partido.colores.primary === "#ffdf00") {
                        target.style.backgroundColor = "#e6c600"; // Amarillo más oscuro
                      } else {
