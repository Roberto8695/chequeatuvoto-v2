...
export default function SectionCandidatos({ slug }: SectionCandidatosProps) {
  ...
  return (
    ...
    >
      ...
      {/* Contenido principal */}
      <div className={`relative z-10 container mx-auto px-4 py-4 flex-1 flex flex-col justify-center transition-all duration-1000 transform ${
        ...
        <div className={`max-w-full mx-auto transition-all duration-1000 delay-400 transform ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 lg:gap-8 items-start px-4 sm:px-0">
            ...
            <div className="group text-center order-2 sm:order-1">
              <div className="relative">
                ...
                <div className="flex justify-center">
                  <Badge className="bg-white/30 backdrop-blur-sm text-white border-0 text-xs font-bold px-3 py-1 shadow-lg">
                    PRESIDENTE
                  </Badge>
                </div>
              </div>
            ...
            <div className="group text-center order-1 sm:order-2">
              <div className="relative w-52 h-66 sm:w-60 sm:h-76 md:w-68 md:h-86 lg:w-76 lg:h-96 mx-auto overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 rounded-2xl bg-white/20 backdrop-blur-sm">
                <Image
        ...
        {(partido.descripcion || partido.sitioWeb) && (
          <div className={`text-center mt-3 transition-all duration-1000 delay-600 transform ${
            ...
            {partido.descripcion && (
              <p className="text-white/70 text-xs max-w-xl mx-auto mb-2 leading-relaxed">
                {partido.descripcion}
              </p>
            )}
            {partido.sitioWeb && (
              <a
                ...
                className="inline-flex items-center space-x-1 bg-white/15 hover:bg-white/25 backdrop-blur-sm text-white font-medium px-3 py-1 rounded-full transition-all duration-300 hover:scale-105 shadow-lg text-xs"
              >
                <span>Sitio web</span>
