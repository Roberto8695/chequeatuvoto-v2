          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-center">
            ...
            <div className="group text-center order-2 md:order-1">
              <div className="relative">
                ...
                <div className="relative w-56 h-72 md:w-64 md:h-80 mx-auto mb-4 overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500 transform group-hover:scale-105 rounded-2xl">
