          ...
          >
            ...
            <CardContent className="p-6 relative z-10 flex flex-col items-center text-center h-full">
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <Button
                  size="sm"
                  className="w-full -webkit-text-stroke text-white font-bold rounded-xl transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-lg text-xs group/btn"
                  style={{
                    backgroundColor: partido.colores?.primary || "#6c757d",
