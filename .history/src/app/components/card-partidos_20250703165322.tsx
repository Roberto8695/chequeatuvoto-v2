        ...
        {partidosPoliticos.map((partido) => (
          ...
          >
            ...
            <CardContent className="p-6 relative z-10 flex flex-col items-center text-center h-full">
              {/* Logo del partido */}
              <div className="relative w-30 h-30 mb-4 rounded-full overflow-hidden bg-white shadow-md group-hover:shadow-lg transition-shadow duration-300">
                <Image
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <Button
                  size="sm"
                  className="w-full text-white font-medium rounded-xl transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-lg text-xs group/btn"
                  style={{
                    backgroundColor: partido.colores?.primary || "#6c757d",
