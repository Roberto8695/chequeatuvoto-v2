        ...
        <div className={`max-w-full mx-auto transition-all duration-1000 delay-400 transform ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-center">
            ...
            <div className="group text-center order-1 md:order-2">
              <div className="relative w-56 h-72 md:w-64 md:h-80 mx-auto overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 rounded-2xl bg-white/20 backdrop-blur-sm">
                <Image
