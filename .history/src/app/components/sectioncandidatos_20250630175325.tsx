          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-20">
            ...
            <div className="group text-center">
              <div className="relative">
                {/* Foto del presidente sin marco - más grande */}
                <div className="relative w-72 h-72 md:w-80 md:h-80 mx-auto mb-8 rounded-full overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500 transform group-hover:scale-105">
                ...
                <div className="flex justify-center">
                  <Badge className="bg-white/30 backdrop-blur-sm text-white border-0 text-base font-bold px-8 py-3 shadow-lg">
                    PRESIDENTE
                  </Badge>
                </div>
              </div>
            ...
            <div className="group text-center">
              <div className="relative">
                {/* Foto del vicepresidente sin marco - más grande */}
                <div className="relative w-72 h-72 md:w-80 md:h-80 mx-auto mb-8 rounded-full overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500 transform group-hover:scale-105">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent z-10"></div>
                  <Image
