      ...
      <div className={`relative z-10 container mx-auto px-4 py-8 flex-1 flex flex-col justify-center transition-all duration-1000 transform ${
        ...
        <div className={`text-center mb-12 transition-all duration-1000 delay-200 transform ${
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="relative w-64 h-64 md:w-72 md:h-72 rounded-full bg-white/20 backdrop-blur-sm p-6 shadow-2xl hover:scale-110 transition-transform duration-300">
              <Image
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24">
            ...
            <div className="group text-center">
              <div className="relative">
                {/* Foto del presidente - alineada con el logo */}
                <div className="relative w-64 h-64 md:w-72 md:h-72 mx-auto mb-6 rounded-full overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500 transform group-hover:scale-105">
            ...
            <div className="group text-center">
              <div className="relative">
                {/* Foto del vicepresidente - alineada con el logo */}
                <div className="relative w-64 h-64 md:w-72 md:h-72 mx-auto mb-6 rounded-full overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500 transform group-hover:scale-105">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent z-10"></div>
                  <Image
