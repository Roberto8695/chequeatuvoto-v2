...
export default function SectionCandidatos({ slug }: SectionCandidatosProps) {
  ...
  return (
    ...
    >
      ...
      {/* Contenido principal */}
      <div className={`relative z-10 container mx-auto px-4 py-8 flex-1 flex flex-col justify-center transition-all duration-1000 transform ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-center">
            ...
            <div className="group text-center order-2 md:order-1">
              <div className="relative">
                {/* Foto del presidente */}
                <div className="relative w-56 h-56 md:w-64 md:h-64 mx-auto mb-4 rounded-full overflow-hidden shadow-2xl group-hover:shadow-3xl transition-all duration-500 transform group-hover:scale-105">
                ...
                <div className="flex justify-center">
                  <Badge className="bg-white/30 backdrop-blur-sm text-white border-0 text-xs md:text-sm font-bold px-4 py-2 shadow-lg">
                    PRESIDENTE
                  </Badge>
                </div>
              </div>
            ...
            <div className="group text-center order-1 md:order-2">
              <div className="relative w-72 h-72 md:w-80 md:h-80 mx-auto rounded-full bg-white/20 backdrop-blur-sm p-6 shadow-2xl hover:scale-110 transition-transform duration-300 group-hover:bg-white/30">
                <Image
            ...
            {/* Vicepresidente */}
            <div className="group text-center order-3 md:order-3">
              <div className="relative">
        ...
        {partido.descripcion && (
          <div className={`max-w-4xl mx-auto mt-8 transition-all duration-1000 delay-600 transform ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
        ...
        {/* Sitio web - más compacto */}
        {partido.sitioWeb && (
          <div className={`text-center mt-4 transition-all duration-1000 delay-800 transform ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}>
            <a
              ...
              className="inline-flex items-center space-x-2 bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white font-semibold px-6 py-2 rounded-full transition-all duration-300 hover:scale-105 shadow-lg text-sm"
            >
