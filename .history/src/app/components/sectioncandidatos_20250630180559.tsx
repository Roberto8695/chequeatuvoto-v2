  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 container mx-auto px-4 py-8 flex-1 flex flex-col justify-center transition-all duration-1000 transform ${
        ...
        <div className={`text-center mb-6 sm:mb-8 transition-all duration-1000 delay-200 transform ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white drop-shadow-lg mb-2">
            {partido.sigla}
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-white/90 max-w-4xl mx-auto leading-relaxed px-4">
            {partido.nombre}
          </p>
        </div>
