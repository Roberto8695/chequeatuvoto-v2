      ...
      <div className={`relative z-10 container mx-auto px-4 py-16 transition-all duration-1000 transform ${
        ...
        <div className={`text-center mb-16 transition-all duration-1000 delay-200 transform ${
          ...
          <div className="flex flex-col items-center space-y-6">
            {/* Logo del partido */}
            <div className="relative w-48 h-48 md:w-56 md:h-56 rounded-full bg-white/20 backdrop-blur-sm p-4 shadow-2xl hover:scale-110 transition-transform duration-300">
              <Image
