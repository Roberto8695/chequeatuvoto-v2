...
export default function LoadingScreen({ onLoadingComplete }: LoadingScreenProps) {
  ...
  useEffect(() => {
    // Verificar si ya se mostró la loading screen en esta sesión
    const hasShownLoading = localStorage.getItem('hasShownLoadingScreen');
    
    if (!hasShownLoading) {
      // Primera vez en la sesión, mostrar loading screen
      setShouldShow(true);
      ...
      // Ya se mostró antes, completar inmediatamente
      onLoadingComplete();
    }
  }, [onLoadingComplete]);
